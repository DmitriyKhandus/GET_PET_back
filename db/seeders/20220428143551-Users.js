...
module.exports = {
  async up(queryInterface) {
    ...
    },
    {
      ...
      aboutUser: 'У меня большой опыт по работе со всеми этими... эээ... компьютерными штуками... ну, Вы знаете... e-mail... посылать e-mail, принимать e-mail, удалять e-mail... эм... я могу долго продолжать... Web, использовать мышь, мышки, использовать мышку, щелчок, двойной щелчок, экран компьютера, ну, само собой, клавиатура и... штука, которую ставят на пол...  Жесткий диск.  Точно!',
      createdAt: new Date(),
      updatedAt: new Date(),
    },
    ]);
